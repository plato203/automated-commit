...
2. Edit the file, replacing `"alexandrosstefanidis055@gmail.com"` with your email and `"plato203"` with your GitHub username in the `Setup Git Configuration` step.
